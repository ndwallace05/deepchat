...
const PLATFORM_SPECIFIC_SERVERS: Record<string, MCPServerConfig> = {
  ...
  ...(isMacOS()
    ? {
        'deepchat/apple-server': {
          args: [],
          descriptions: 'ARIA built-inApple系统集成服务 (仅macOS)',
          icons: '🍎',
          autoApprove: ['all'],
  ...
  ...(isWindows()
    ? {
        ...
        //   args: [],
        //   descriptions: 'ARIA built-in Windows system integration service (Windows only)',
        //   icons: '🪟',
        //   autoApprove: ['all'],
        //   type: 'inmemory' as MCPServerType,
  ...
  ...(isLinux()
    ? {
        ...
        //   args: [],
        //   descriptions: 'ARIA built-in Linux system integration service (Linux only)',
        //   icons: '🐧',
        //   autoApprove: ['all'],
        //   type: 'inmemory' as MCPServerType,
...
const DEFAULT_INMEMORY_SERVERS: Record<string, MCPServerConfig> = {
  buildInFileSystem: {
    ...
    descriptions: 'ARIA built-in文件系统mcp服务',
    icons: '📁',
    autoApprove: ['read'],
    type: 'inmemory' as MCPServerType,
    command: 'filesystem',
  ...
  Artifacts: {
    args: [],
    descriptions: 'ARIA built-in artifacts mcp服务',
    icons: '🎨',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'artifacts',
  ...
  bochaSearch: {
    args: [],
    descriptions: 'ARIA built-in博查搜索服务',
    icons: '🔍',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'bochaSearch',
  ...
  braveSearch: {
    args: [],
    descriptions: 'ARIA built-inBrave搜索服务',
    icons: '🦁',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'braveSearch',
  ...
  difyKnowledge: {
    args: [],
    descriptions: 'ARIA built-inDify知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  powerpack: {
    args: [],
    descriptions: 'ARIA built-in增强工具包',
    icons: '🛠️',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'powerpack',
  ...
  ragflowKnowledge: {
    args: [],
    descriptions: 'ARIA built-inRAGFlow知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  fastGptKnowledge: {
    args: [],
    descriptions: 'ARIA built-inFastGPT知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  builtinKnowledge: {
    args: [],
    descriptions: 'ARIA built-in知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  'deepchat-inmemory/deep-research-server': {
    args: [],
    descriptions:
      'ARIA built-in深度研究服务，使用博查搜索(注意该服务需要较长的上下文模型，请勿在短上下文的模型中使用)',
    icons: '🔬',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  'deepchat-inmemory/auto-prompting-server': {
    args: [],
    descriptions: 'ARIA built-in自动模板提示词服务',
    icons: '📜',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  'deepchat-inmemory/conversation-search-server': {
    args: [],
    descriptions: 'ARIA built-in conversation history search service',
    icons: '🔍',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  'deepchat-inmemory/meeting-server': {
    args: [],
    descriptions: 'ARIA built-in会议服务，用于组织多Agent讨论',
    icons: '👥',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
